...
const Points = () => {
    ...
    const routeParams = route.params as {uf: string, city: string};

    const navigation = useNavigation();
    const [items, setItems] = useState<{id: number, title: string, image_url: string}[]>([]);
    ...
    useEffect(() => {
        ...
        (async function loadPosition() {
            ...
            if (status !== "granted") {
                Alert.alert("Ooops...", "Precisamos de sua permissão para obeter a localização");
                return;
            }
